...
class ProductDetailSpecific {
  ContentProductDetailSpecific? _content;
  Null? _error;
  bool? _isSuccess;
  ...
  ProductDetailSpecific(
      {ContentProductDetailSpecific? content,
      Null? error,
      bool? isSuccess,
      String? responseTime,
  ...
  ContentProductDetailSpecific? get content => _content;
  set content(ContentProductDetailSpecific? content) => _content = content;
  ...
  ProductDetailSpecific.fromJson(Map<String, dynamic> json) {
    _content = json['content'] != null
        ? ContentProductDetailSpecific.fromJson(json['content'])
        : null;
    _error = json['error'];
...
class ContentProductDetailSpecific {
  int? _productId;
  String? _productName;
  double? _price;
  ...
  ContentProductDetailSpecific.fromJson(Map<String, dynamic> json) {
